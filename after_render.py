...
print("")
print ("")                                                        
print ("  ___   __ _           ______               _           ")
print (" / _ \ / _| |          | ___ \             | |          ")
print ("/ /_\ \ |_| |_ ___ _ __| |_/ /___ _ __   __| | ___ _ __ ")
print ("|  _  |  _| __/ _ \ '__|    // _ \ '_ \ / _` |/ _ \ '__|")
print ("| | | | | | ||  __/ |  | |\ \  __/ | | | (_| |  __/ |   ")
print ("\_| |_/_|  \__\___|_|  \_| \_\___|_| |_|\__,_|\___|_|   ")
print ("                  ______                                ")
print ("                 |______|                               ")
print ("                                                        ")
...
path = inputE("Local do Arquivo: " )
if path[len(path) - 1] != "/" and path[len(path) - 1] != "\\":
    path = os.path.join(path, "")
while not os.path.exists(path):
    print("O local do arquivo e invalido ou nao existe!")
    path = inputE("Local do Arquivo: " )

validFlag = False
while not validFlag:
    project = inputE("Nome do projeto: ")
    if not project:
        print("Nenhum projeto especificado. O After Effects renderizará seu projeto aberto no momento.")
        validFlag = True
    else:
...
composition = inputE("Nome da composicao: ")
if not composition:
...
while not validFlag:
    ...
    if framerate == "":
        ...
        try:
            ...
            print("Framerate não pode ser inferior ou igual a zero!")
...
def review():
    ...
    validFlag = False
    while not validFlag:
        delF = inputE("Deletar fragmentos do video ?. (y/n): ")
        if not delF:
